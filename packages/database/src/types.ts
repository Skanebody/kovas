...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      audit_conformite_reports: {
        Row: {
          ai_cost_eur: number | null
          generated_at: string
          high_risk_missions: Json | null
          id: string
      ...
      audit_retroactif_reports: {
        Row: {
          ai_cost_eur: number | null
          completed_at: string | null
          created_at: string
          f_g_missions_count: number | null
          high_risk_missions_count: number | null
          id: string
          missions_imported_count: number | null
          pdf_url: string | null
          status: string
          user_id: string
        }
      ...
      automated_email_sequences: {
        ...
        Relationships: [
          {
            foreignKeyName: 'automated_email_sequences_mission_id_fkey'
            columns: ['mission_id']
            isOneToOne: false
            referencedRelation: 'missions'
            referencedColumns: ['id']
      ...
      cabinet_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: 'cabinet_reports_cabinet_id_fkey'
            columns: ['cabinet_id']
            isOneToOne: false
            referencedRelation: 'organizations'
            referencedColumns: ['id']
      ...
      claim_requests: {
        Row: {
          ...
          identity_kyc_reasons: Json | null
          ...
          kyc_reviewer_user_id: string | null
          method: string
      ...
      diagnosticians: {
        Row: {
          ...
          annuaire_tier: Database['public']['Enums']['annuaire_tier']
      ...
      dossier_export_annexes: {
        ...
        Relationships: [
          {
            foreignKeyName: 'dossier_export_annexes_dossier_id_fkey'
            columns: ['dossier_id']
            isOneToOne: false
            referencedRelation: 'dossiers'
            referencedColumns: ['id']
          ...
          {
            foreignKeyName: 'dossier_export_annexes_organization_id_fkey'
            columns: ['organization_id']
            isOneToOne: false
            referencedRelation: 'organizations'
            referencedColumns: ['id']
      ...
      georisques_radon_cache: {
        Row: {
          classe: number
          code_insee: string
          fetched_at: string
          obligation_ial: boolean
          raw_data: Json
        }
        Insert: {
          classe: number
      ...
      lifetime_deal_purchases: {
        Row: {
          amount_cents: number
          cabinet_access_expires_at: string
      ...
      mission_flow_events: {
        ...
        Relationships: [
          {
            foreignKeyName: 'mission_flow_events_mission_id_fkey'
            columns: ['mission_id']
            isOneToOne: false
            referencedRelation: 'missions'
            referencedColumns: ['id']
          ...
          {
            foreignKeyName: 'mission_flow_events_organization_id_fkey'
            columns: ['organization_id']
            isOneToOne: false
            referencedRelation: 'organizations'
            referencedColumns: ['id']
      ...
      mission_flow_states: {
        Row: {
          ...
          current_step: string | null
          id: string
          last_device_user_agent: string | null
          last_seen_message_id: string | null
          mission_id: string
          organization_id: string
          pre_export_started_at: string | null
        ...
        Relationships: [
          {
            foreignKeyName: 'mission_flow_states_mission_id_fkey'
            columns: ['mission_id']
            isOneToOne: true
            referencedRelation: 'missions'
            referencedColumns: ['id']
          ...
          {
            foreignKeyName: 'mission_flow_states_organization_id_fkey'
            columns: ['organization_id']
            isOneToOne: false
            referencedRelation: 'organizations'
            referencedColumns: ['id']
      ...
      mission_room_items: {
        ...
        Relationships: [
          {
            foreignKeyName: 'mission_room_items_dossier_room_id_fkey'
            columns: ['dossier_room_id']
            isOneToOne: false
            referencedRelation: 'dossier_rooms'
            referencedColumns: ['id']
          },
          {
            foreignKeyName: 'mission_room_items_organization_id_fkey'
            columns: ['organization_id']
            isOneToOne: false
            referencedRelation: 'organizations'
            referencedColumns: ['id']
      ...
      observatoire_renovations_monthly: {
        Row: {
          class_transitions: Json
          dpe_count: number
          id: string
          ingested_at: string
          period_month: number
      ...
      organizations: {
        Row: {
          ...
          baseline_minutes_per_mission: number
          bic: string | null
          certification_n: string | null
          city: string | null
          country: string
      ...
      premium_reports_generated: {
        Row: {
          ai_cost_eur: number | null
          generated_at: string
          id: string
          mission_id: string
          opened_by_client_at: string | null
          pdf_url: string
        ...
        Relationships: [
          {
            foreignKeyName: 'premium_reports_generated_mission_id_fkey'
            columns: ['mission_id']
            isOneToOne: false
            referencedRelation: 'missions'
            referencedColumns: ['id']
      ...
      press_release_sends: {
        ...
        Relationships: [
          {
            foreignKeyName: 'press_release_sends_press_contact_id_fkey'
            columns: ['press_contact_id']
            isOneToOne: false
            referencedRelation: 'press_contacts'
            referencedColumns: ['id']
          },
          {
            foreignKeyName: 'press_release_sends_press_release_id_fkey'
      ...
      press_releases: {
        Row: {
          ...
          key_figures: Json
          key_quotes: Json
          observatoire_report_id: string | null
          pdf_size_bytes: number | null
          pdf_url: string | null
        ...
        Relationships: [
          {
            foreignKeyName: 'press_releases_observatoire_report_id_fkey'
            columns: ['observatoire_report_id']
            isOneToOne: false
            referencedRelation: 'observatoire_reports'
            referencedColumns: ['id']
          },
        ]
      }
      ...
      tunnel_signup_state: {
        Row: {
          audit_retroactif_purchased: boolean
          awareness_level: number | null
          created_at: string
          current_step: string
          order_bump_audit_retro: boolean
          quiz_current_editor: string | null
          quiz_monthly_missions: number | null
          quiz_team_size: string | null
    ...
    Views: {
      ...
      v_etat_profession_by_dept: {
        Row: {
          avg_activity_score: number | null
          claimed_count: number | null
          department_code: string | null
          sirene_active_count: number | null
          total_count: number | null
          verified_count: number | null
          very_active_count: number | null
        }
        Relationships: []
      }
      v_etat_profession_summary: {
        Row: {
          ceased_count: number | null
          claimed_count: number | null
          dhup_synced_last_7d_count: number | null
          last_dhup_sync_at: string | null
          low_activity_count: number | null
          moderately_active_count: number | null
          pending_count: number | null
          sirene_active_count: number | null
          sirene_closed_count: number | null
          suspended_count: number | null
          total_diagnosticians: number | null
          unclaimed_count: number | null
          unverified_count: number | null
          verified_count: number | null
          very_active_count: number | null
          with_fraud_flags_count: number | null
          with_sirene_count: number | null
        }
        Relationships: []
      }
      ...
      v_press_mentions_stats: {
        Row: {
          active_press_contacts: number | null
          last_mention_at: string | null
          last_release_sent_at: string | null
          total_mentions: number | null
          total_releases_sent: number | null
          unique_outlets: number | null
        }
        Relationships: []
      }
    ...
    Functions: {
      ...
      bandit_thompson_rank: {
        Args: { p_diagnostician_ids: string[] }
        Returns: {
          alpha: number
          beta: number
          conversions: number
      ...
      create_or_get_mission_room_item: {
        Args: {
          p_client_local_id?: string
          p_data: Json
      ...
      get_diagnostician_response_metrics: {
      ...
      invoke_purge_old_data: { Args: never; Returns: string }
      invoke_regulatory_watcher: { Args: never; Returns: string }
      ...
      kovas_slugify: { Args: { input_text: string }; Returns: string }
      lifetime_deal_spots_remaining: { Args: never; Returns: number }
      log_dossier_event: {
        Args: {
      ...
      mission_flow_transition: {
        Args: {
          p_expected_ver?: number
          p_mission_id: string
          p_payload?: Json
          p_to_phase: string
          p_to_step?: string
      ...
      route_lead_rank_candidates: {
        Args: {
          p_lat: number
          p_limit?: number
          p_lng: number
          p_only_subscribed?: boolean
          p_radius_km?: number
        }
        Returns: {
          activity_score: number
    ...
    Enums: {
      annuaire_tier: 'free' | 'presence' | 'boost' | 'premium'
