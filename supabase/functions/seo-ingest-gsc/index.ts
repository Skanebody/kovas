...
function getMockGscRows(): GscQueryRow[] {
  return [
    ...
    { keys: ["diagnostic immobilier dieppe"], clicks: 18, impressions: 420, ctr: 0.043, position: 5.1 },
    { keys: ["amiante avant 1997"], clicks: 32, impressions: 980, ctr: 0.033, position: 11.4 },
    { keys: ["diagnostic plomb crep prix"], clicks: 12, impressions: 350, ctr: 0.034, position: 14.8 },
    ...
    { keys: ["diagnostic gaz copropriete"], clicks: 9, impressions: 280, ctr: 0.032, position: 16.3 },
    ...
    { keys: ["diagnostic electricite obligatoire"], clicks: 41, impressions: 1180, ctr: 0.035, position: 10.5 },
  ];
}
