 ...
 */
export const InputWithLiveValidation = forwardRef<
  HTMLInputElement,
  InputWithLiveValidationProps
    ...
    <div className="space-y-1.5">
      <div className="relative">
        <Input
          ...
          className={cn(
            showIcon && 'pr-9',
            state === 'invalid' && 'border-accent-red focus-visible:border-accent-red focus-visible:ring-accent-red/15',
      ...
      {state === 'valid' && hint ? (
        <p className="text-[11px] text-accent-green">{hint}</p>
      ) : null}
    </div>
  )
})
