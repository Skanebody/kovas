 ...
 *
 * Workflow résiliation `/app/account/cancellation?step=1` PROTÉGÉ (décret 2023-417).
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          {isActive && (
            <Button asChild variant="outline" size="sm" className="flex-1">
              <Link href="/app/account/cancellation?step=1">
