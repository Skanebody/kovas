...
export async function createFollowUpSequenceAction(
  ...
  if (targetType === 'quote') revalidatePath(`/app/devis/${targetId}`)
  if (targetType === 'invoice') revalidatePath(`/app/factures/${targetId}`)
  if (targetType === 'mission') revalidatePath(`/app/dossiers/${targetId}`)
