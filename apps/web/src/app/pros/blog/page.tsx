...
const POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    title: 'Cohabiter avec Liciel : workflow KOVAS compagnon',
    excerpt:
      'Le terrain dans KOVAS, le calcul dans Liciel. Comment configurer le bouton Partager pour zéro re-saisie.',
