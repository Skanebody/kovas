  ...
  return (
    <div className="sticky top-0 z-10 -mx-2 sm:mx-0">
      <div className="relative mx-2 sm:mx-0">
        <Search
          className="absolute left-4 top-1/2 -translate-y-1/2 size-4 text-[#0F1419]/72 pointer-events-none"
          aria-hidden
        />
        <input
          type="search"
          ...
          className="w-full pl-11 pr-10 py-2.5 rounded-full bg-paper border border-[#0F1419]/[0.08] shadow-sm text-[13px] text-[#0F1419] placeholder:text-[#0F1419]/40 focus:outline-none focus:ring-2 focus:ring-chartreuse/40 focus:border-chartreuse-deep transition-all"
        ...
        {value ? (
          <button
            type="button"
            onClick={() => setValue('')}
            className="absolute right-3 top-1/2 -translate-y-1/2 size-7 inline-flex items-center justify-center rounded-full text-[#0F1419]/72 hover:text-[#0F1419] hover:bg-[#0F1419]/5 transition-colors"
