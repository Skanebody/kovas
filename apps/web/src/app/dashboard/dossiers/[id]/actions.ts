...
export async function resumeMissionAction(missionId: string) {
  ...
  revalidatePath(`/dashboard/dossiers/${current.dossier_id}`)
...
export async function updateMissionStatusAction(missionId: string, newStatus: MissionStatus) {
  ...
  if (error) throw new Error(error.message)
  if (updated?.dossier_id) revalidatePath(`/dashboard/dossiers/${updated.dossier_id}`)
  revalidatePath('/dashboard/dossiers')
  revalidatePath('/dashboard/dashboard')
}
...
export async function toggleChecklistItemAction(
  ...
  if (error) throw new Error(error.message)
  if (current?.dossier_id) revalidatePath(`/dashboard/dossiers/${current.dossier_id}`)
}
...
export async function removeMissionFromDossierAction(missionId: string) {
  ...
  if (error) throw new Error(error.message)
  if (m?.dossier_id) revalidatePath(`/dashboard/dossiers/${m.dossier_id}`)
}
...
export async function updateRoomAction(
  ...
  if (error) throw new Error(error.message)
  if (room?.dossier_id) revalidatePath(`/dashboard/dossiers/${room.dossier_id}`)
}
