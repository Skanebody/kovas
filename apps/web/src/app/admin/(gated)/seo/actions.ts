...
// Helpers déplacés vers ./eeat.ts pour pouvoir être importés depuis
// SeoDraftEditor.tsx (Client Component). Réexports gardés pour compat.
const computeEeatValidations = _computeEeatValidations
const computeEeatScore = _computeEeatScore
