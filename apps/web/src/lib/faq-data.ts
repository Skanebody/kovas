...
export const FAQ_LANDING: FaqQuestion[] = [
  ...
  },
  {
    ...
    answer:
      "Oui, KOVAS offre **14 jours d'essai gratuit ou 30 missions complètes**, selon ce qui arrive en premier. Toutes les fonctionnalités sont accessibles sans restriction : saisie vocale, photos terrain, exports vers Liciel, partage des dossiers, lien d'upload pour les documents propriétaire.\n\nAucune carte bancaire n'est requise pour démarrer (email professionnel suffit). À l'issue de la période d'essai, vous choisissez librement votre formule. En cas de non-conversion, votre compte bascule **90 jours en mode lecture et export complet** (PDF, Word, CSV, JSON, ZIP Liciel) avant suppression définitive des données opérationnelles.",
  },
  {
  ...
  // ============================================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Changement et résiliation s'effectuent en **3 clics maximum depuis votre espace abonnement** (conforme décret 2023-417 « résiliation en 3 clics »).\n\n- **Passer à une formule supérieure** : changement immédiat avec ajustement prorata sur la facture du mois en cours\n- **Passer à une formule inférieure ou résilier** : prend effet à la fin de la période en cours (mensuelle ou annuelle), aucune coupure brutale\n\nAprès expiration de l'abonnement :\n\n- Votre compte bascule **90 jours en mode lecture et export complet** (PDF, Word, CSV, JSON, ZIP Liciel)\n- Aucune saisie nouvelle, accès illimité aux dossiers existants pour reprendre votre travail à votre rythme\n- Au-delà des 90 jours, vos données opérationnelles sont purgées des systèmes de production\n- Vos factures restent conservées **10 ans** (obligation légale comptable, articles L123-22 et L102 B)\n\nUne demande explicite d'effacement RGPD (Art. 17) adressée à rgpd@kovas.fr est traitée sous 30 jours maximum (procédure distincte d'une simple résiliation). Aucune justification ni lettre recommandée n'est nécessaire pour résilier.",
      },
      {
