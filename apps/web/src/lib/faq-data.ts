...
export const FAQ_LANDING: FaqQuestion[] = [
  ...
  },
  {
    ...
    answer:
      "Oui, KOVAS offre **30 jours d'essai gratuit complet**, sans restriction de missions ni de fonctionnalités : saisie vocale, photos terrain, exports vers Liciel, partage des dossiers, lien d'upload pour les documents propriétaire.\n\nUne carte bancaire est demandée à l'inscription pour valider ton identité professionnelle (Setup Intent Stripe — aucun débit pendant l'essai). À J+30, ton abonnement est automatiquement activé au tarif du forfait choisi. Tu peux résilier à tout moment en 2 clics depuis ton espace, sans frais ni justification. Si tu résilies pendant l'essai, tes données restent accessibles 30 jours supplémentaires en lecture seule avant suppression définitive.",
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "Pour démarrer ta première mission :\n\n1. Crée un nouveau dossier depuis le bouton \"+ Nouveau dossier\" du tableau de bord\n2. Renseigne l'identité du bien (adresse via l'API BAN qui pré-remplit automatiquement, année de construction, surface)\n3. Ajoute les diagnostics souhaités (DPE, amiante, plomb, gaz, électricité, termites, Carrez, ERP)\n4. Envoie le lien d'upload public à ton client par email ou SMS pour qu'il te transmette ses documents (factures EDF, anciens DPE, plans)\n5. Le jour du rendez-vous, ouvre le dossier et utilise le mode mission pour la saisie vocale et les photos terrain",
      },
      {
        id: 'saisie-vocale',
        question: 'Comment fonctionne la saisie vocale dans KOVAS ?',
        answer:
          "La saisie vocale transcrit et structure automatiquement tes observations terrain. Appuie sur le bouton micro depuis n'importe quelle pièce du dossier et décris à voix haute, par exemple : « Salon de 25 mètres carrés, plancher chauffant gaz, double vitrage récent, radiateurs en fonte ».\n\nL'intelligence artificielle utilise **Whisper d'OpenAI** pour la transcription et un parser custom + **Claude Haiku** pour l'extraction d'entités (type de pièce, surface, type de chauffage, équipements). Tu valides ou corriges les informations en un clic. La saisie vocale fonctionne en français.",
      },
      {
        id: 'photos-organisation',
        question: 'Comment prendre et organiser les photos dans KOVAS ?',
        answer:
          "Les photos sont optimisées automatiquement : compression WebP qualité 0.75, redimensionnement maximal 1920×1080, géolocalisation EXIF si autorisée, nommage du fichier automatique au format `date_pièce_index_typeVue_référence.webp`.\n\nPour prendre une photo, sélectionne d'abord la pièce concernée, puis le type de vue (vue générale, radiateur, chaudière, plaque signalétique, étiquette énergétique, etc.). Clique sur « Prendre photo(s) » — tu peux en prendre plusieurs successivement avec la caméra de ton smartphone ou tablette. Les photos sont automatiquement liées au dossier et à la pièce sélectionnée.",
      },
      {
        id: 'export-liciel',
        question: 'Comment exporter un dossier KOVAS vers Liciel ?',
        answer:
          "Ouvre le dossier concerné, vérifie que les missions sont marquées comme « Terminées sur le terrain », puis clique sur « Partager vers Liciel ». KOVAS génère automatiquement un fichier ZIP au format Liciel officiel contenant la base Access MDB, les fichiers XML structurés par diagnostic, les photos organisées par pièce, et les documents propriétaire.\n\n3 modes de partage disponibles : email à toi-même, synchronisation automatique Google Drive ou Dropbox, ou téléchargement direct. Tu importes ensuite le ZIP dans Liciel via son interface d'import standard. L'opération complète prend généralement 30 secondes à 1 minute, contre 1h30 à 2h pour une re-saisie complète manuelle.",
      },
      {
        id: 'transmettre-rapport-client',
        question: 'Comment KOVAS facilite-t-il la transmission du rapport au client ?',
        answer:
          "KOVAS centralise tous les rapports et documents dans le dossier client pour faciliter la transmission. Une fois ton rapport finalisé (PDF Liciel certifié pour le DPE, rapport généré par ton logiciel actuel pour les autres diagnostics), tu le télécharges depuis le dossier et l'envoies via ta messagerie habituelle ou plateforme client.\n\nLe rapport est archivé dans KOVAS avec ses métadonnées (date, photos preuves, notes vocales liées) pour la durée légale applicable : **10 ans** pour la plupart des diagnostics, **50 ans** pour l'amiante. Cette traçabilité protège ta certification en cas de contrôle DGCCRF ou organisme certificateur.",
      },
      {
        id: 'lien-upload-client',
        question: "Comment fonctionne le lien d'upload pour les documents client ?",
        answer:
          "Pour chaque dossier, KOVAS génère un lien d'upload public sécurisé que tu peux envoyer à ton client par email ou SMS avant le rendez-vous. Le client ouvre le lien depuis n'importe quel navigateur, **sans création de compte**, et uploade directement ses documents : factures d'énergie (12 derniers mois pour le DPE), anciens DPE éventuels, plans du bien, documents cadastraux.\n\nLe lien est valable **30 jours**, renouvelable et révocable à tout moment depuis ton interface. Tu vois la liste des documents reçus directement dans le dossier. Les documents sont chiffrés en transit et stockés en Europe.",
      },
    ],
  },
  ...
  // ============================================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Vérifie ces 5 critères essentiels :\n\n1. **La certification COFRAC** : exige les attestations à jour pour chaque diagnostic concerné. Tu peux vérifier gratuitement sur l'annuaire officiel du Ministère du Logement (annuaire-diagnostiqueurs.gouv.fr)\n2. **L'indépendance** : le diagnostiqueur ne doit avoir aucun lien commercial avec l'agence immobilière qui vend ton bien (interdiction légale)\n3. **L'assurance Responsabilité Civile Professionnelle** : demande l'attestation. C'est elle qui te couvrira en cas de défaut de diagnostic découvert plus tard\n4. **Les délais et tarifs transparents** : un bon diagnostiqueur affiche ses tarifs et propose une intervention sous 7 jours en zone urbaine\n5. **Les avis clients** : consulte Google Maps et les avis vérifiés pour évaluer la qualité de service\n\nÉvite les diagnostiqueurs qui proposent des prix anormalement bas (en dessous de 80€ pour un DPE seul est suspect en 2026) car ils signalent souvent un travail bâclé.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Il est recommandé de faire réaliser les diagnostics immobiliers **2 à 4 semaines avant la mise en vente**. Cette anticipation permet de :\n\n- Disposer du DPE pour les annonces (la classe énergétique est obligatoire dans toute annonce depuis 2011, et le détail des consommations depuis 2022)\n- Prendre connaissance des résultats et prévoir d'éventuels travaux d'amélioration énergétique (notamment pour les classes F/G qui nécessitent un audit énergétique)\n- Comparer plusieurs devis de diagnostiqueurs\n- Organiser le rendez-vous selon ta disponibilité\n\nAttention : l'ERP doit être daté de moins de 6 mois au jour de la signature du compromis, donc inutile de le faire trop tôt si la vente prend du temps.",
      },
      {
        id: 'erreur-rapport-diagnostiqueur',
        question: 'Que faire si le diagnostiqueur a fait une erreur dans son rapport ?',
        answer:
          "Plusieurs recours sont possibles selon la nature de l'erreur :\n\n1. **Contacte le diagnostiqueur directement** pour signaler l'erreur. Il peut corriger gratuitement un rapport ou refaire une visite si l'erreur est manifeste et récente\n2. **Saisis l'organisme certificateur COFRAC** (Bureau Veritas Certification, AFNOR Certification, etc.) qui a délivré la certification. Une plainte peut entraîner une suspension ou un retrait de certification\n3. **Active l'assurance Responsabilité Civile Professionnelle** du diagnostiqueur en cas de préjudice financier (couverture obligatoire jusqu'à 300 000€ minimum)\n4. **Saisis la DGCCRF** pour les fraudes manifestes\n5. **En dernier recours, engage une action judiciaire** devant le tribunal judiciaire dans un délai de 5 ans à compter de la découverte de l'erreur\n\nConserve tous les éléments de preuve : rapports originaux, photos, factures, devis de travaux supplémentaires liés à l'erreur.",
      },
    ],
  },
    ...
    questions: [
      {
        ...
        answer:
          "Un diagnostic amiante avant vente coûte en moyenne entre **80€ et 250€ TTC** en France, selon la surface du bien et la nécessité éventuelle de prélèvements en laboratoire. Pour un appartement standard de 60 m², compte 80€ à 150€. Pour une maison individuelle de 120 m², le tarif moyen est de 150€ à 250€.\n\nLes prélèvements complémentaires en laboratoire COFRAC ajoutent 50€ à 80€ par échantillon. Le diagnostic amiante est obligatoire pour tous les biens dont le permis de construire est antérieur au 1er juillet 1997, sans exception. Sa validité est **illimitée** en cas d'absence d'amiante détectée, ou **3 ans** en cas de présence avec suivi périodique.",
      },
      {
  ...
  // ============================================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "KOVAS fonctionne sur tous les appareils modernes via navigateur web :\n\n- **Smartphone** : iOS 14+ ou Android 10+\n- **Tablette** : iPad ou tablette Android\n- **Ordinateur** : Windows, Mac, Linux avec Chrome, Safari, Firefox, Edge récents\n\nAucune installation requise pour démarrer, mais tu peux « installer » KOVAS comme une application native (Progressive Web App) :\n\n- **Sur iPhone/iPad** : ouvre Safari → bouton Partager → « Sur l'écran d'accueil »\n- **Sur Android** : ouvre Chrome → menu (3 points) → « Installer l'application »\n\nL'installation PWA permet l'accès hors-ligne complet et une icône sur ton écran d'accueil. Tes données sont automatiquement synchronisées entre tous tes appareils : tu peux démarrer une mission sur tablette sur le terrain et la finaliser sur ordinateur au bureau, sans perte d'information.",
      },
      {
  ...
  // ============================================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Non, KOVAS ne pratique **aucun engagement ni frais caché**. Le prix affiché est le prix payé, et la résiliation se fait en 1 clic depuis ton espace abonnement.\n\nTout est inclus dans l'abonnement mensuel :\n\n- Toutes les fonctionnalités d'intelligence artificielle (transcription vocale, structuration)\n- Stockage selon la formule (20/50/100 Go)\n- Synchronisation multi-appareils\n- Sauvegardes automatiques journalières\n- Support utilisateur par email\n- Mises à jour produit automatiques\n\nLes seuls éléments non inclus sont les outils tiers que tu paies déjà séparément : ton abonnement Liciel (pour le calcul DPE), ton éventuel abonnement Yousign pour la signature électronique. Une facture conforme est générée chaque mois et téléchargeable depuis ton espace.",
      },
      {
        id: 'roi-reel-kovas',
      ...
      },
      {
        ...
        answer:
          "Changement et résiliation s'effectuent en **1 clic depuis ton espace abonnement** dans les paramètres du compte.\n\n- **Passer à une formule supérieure** : changement immédiat avec ajustement prorata sur la facture du mois en cours\n- **Passer à une formule inférieure ou résilier** : prend effet à la fin du mois en cours pour éviter toute perte de service\n\nAprès résiliation :\n\n- Tes données restent accessibles **30 jours en lecture seule**\n- Tu peux exporter tous tes dossiers (PDF, JSON, ZIP Liciel) pour archivage personnel\n- Au-delà de 30 jours, tes données sont définitivement supprimées conformément au RGPD\n- Tu peux réactiver ton compte dans les 30 jours sans perte de données\n\nAucune justification ni lettre recommandée n'est nécessaire.",
      },
      {
        id: 'depassement-quota',
        question: 'Que se passe-t-il si je dépasse le nombre de missions de ma formule ?',
        answer:
          'Si tu dépasses ton quota mensuel, KOVAS facture les missions supplémentaires à un tarif unitaire dégressif selon ta formule :\n\n- **Solo** : 0,99€/mission au-delà de 40\n- **Pro** : 0,79€/mission au-delà de 100\n- **Cabinet** : 0,59€/mission au-delà de 300\n- **Cabinet+** : 0,29€/mission au-delà de 1000\n\nTu restes fonctionnel sans interruption. Si tu dépasses régulièrement ton quota 3 mois consécutifs, KOVAS te suggère automatiquement la formule supérieure (potentiellement plus économique).\n\nUn plafond mensuel auto-protecteur est également activable : au-delà du plafond que tu définis, les missions restent fonctionnelles mais le branding KOVAS revient sur les PDF — tu évites ainsi tout dépassement budgétaire surprise.',
      },
    ],
  },
  ...
  // ============================================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Oui, KOVAS est conforme au Règlement Général sur la Protection des Données (RGPD) européen depuis sa conception. Tous les droits RGPD sont garantis et exerçables à tout moment :\n\n- **Droit d'accès** (Article 15 RGPD) : consultation de toutes vos données depuis votre espace en 1 clic\n- **Droit de rectification** (Article 16 RGPD) : modification de vos informations personnelles à tout moment\n- **Droit à l'effacement** (Article 17 RGPD) : suppression définitive de votre compte et de toutes vos données sous 30 jours\n- **Droit à la portabilité** (Article 20 RGPD) : export complet en formats universels (JSON, CSV, PDF, ZIP)\n- **Droit d'opposition** (Article 21 RGPD) : opposition à certains traitements (marketing, analytics)\n- **Droit à la limitation** (Article 18 RGPD) : limitation du traitement dans des cas spécifiques\n\nPour exercer ces droits, une simple demande à contact@kovas.fr déclenche une réponse sous 30 jours maximum. KOVAS ne pratique aucun profilage commercial, ne revend jamais tes données à des tiers, et ne les utilise pas pour de la publicité ciblée.",
      },
      {
