/**
 * Guide long — Mesurage Carrez et Boutin.
 *
 * Sources : loi 96-1107 du 18 décembre 1996 (Carrez), décret 97-532 du
 * 23 mai 1997, articles 46 et suivants de la loi 65-557 du 10 juillet 1965,
 * article R111-2 du Code de la construction et de l'habitation (Boutin),
 * loi SRU du 13 décembre 2000.
 */

import type { Guide } from '../types'

export const CARREZ_GUIDE: Guide = {
  type: 'carrez',
  slug: 'carrez',
  shortTitle: 'Carrez / Boutin',
  title: 'Mesurage Carrez et Boutin : guide complet 2026',
  category: 'vente',
  tagline:
  ...
  metaDescription:
    'Mesurage Carrez Boutin 2026 : loi 96-1107, surface privative copropriété, surface habitable location, tolérance ±5 %. Guide complet KOVAS.',
  teaser:
    'Loi Carrez (vente copropriété) et loi Boutin (location), méthode, tolérance ±5 % et recours acquéreur.',
  publishedAt: '2026-05-22T08:00:00.000Z',
  updatedAt: '2026-05-22T08:00:00.000Z',
  readingTimeMinutes: 25,
  wordCount: 5050,
  relatedTypes: ['dpe', 'erp', 'amiante', 'plomb'],
  sections: [
    {
      id: 'qu-est-ce-que-le-mesurage-carrez-et-boutin',
      title: 'Qu’est-ce que le mesurage Carrez et Boutin',
      level: 2,
      paragraphs: [
    ...
    {
      id: 'quand-le-mesurage-est-il-obligatoire',
      title: 'Quand le mesurage Carrez et Boutin est-il obligatoire',
      level: 2,
      paragraphs: [
    ...
    {
      id: 'deroulement-du-mesurage',
      title: 'Comment se déroule un mesurage Carrez ou Boutin',
      level: 2,
      paragraphs: [
      ...
      howToSteps: [
        {
          position: 1,
          name: 'Identification du lot et étude documentaire',
          text: "Le diagnostiqueur consulte le règlement de copropriété et le plan cadastral pour identifier précisément le lot à mesurer et ses limites.",
        },
        {
          position: 2,
          name: 'Mesurage pièce par pièce',
          text: "Mesure des dimensions intérieures de chaque pièce au télémètre laser de précision. Consignation des longueurs, largeurs, hauteurs et particularités.",
        },
        {
          position: 3,
          name: 'Vérification des hauteurs sous plafond',
          text: "Identification des parties à hauteur supérieure ou égale à 1,80 m, seules prises en compte dans le calcul. Cartographie des sous-pentes et combles aménagés.",
        },
        {
          position: 4,
          name: 'Décomposition des surfaces complexes',
          text: "Décomposition des géométries irrégulières en surfaces élémentaires (rectangles, triangles, trapèzes) pour un calcul rigoureux des aires.",
        },
        {
          position: 5,
          name: 'Calcul des surfaces et exclusions',
          text: "Application des règles d’exclusion (murs, cloisons, gaines, embrasures, parties basses). Calcul de la surface Carrez ou Boutin finale.",
        },
        {
          position: 6,
          name: 'Rapport et plan coté',
          text: "Établissement du rapport synthétique avec détail des surfaces par pièce et plan coté à l’échelle. Le rapport mentionne explicitement les parties non comptabilisées.",
        },
      ],
    },
    {
      id: 'prix-d-un-mesurage',
      title: 'Combien coûte un mesurage Carrez ou Boutin',
      level: 2,
      paragraphs: [
    ...
    {
      id: 'que-faire-en-cas-d-erreur',
      title: 'Que faire en cas d’erreur de mesurage',
      level: 2,
      paragraphs: [
    ...
    {
      id: 'differences-entre-carrez-boutin-et-surface-de-plancher',
      title: 'Différences entre Carrez, Boutin et surface de plancher',
      level: 2,
      paragraphs: [
  ...
  faq: [
    {
      question: 'À quoi sert la loi Carrez ?',
      answer:
        "La loi Carrez de 1996 oblige le vendeur d’un lot de copropriété à mentionner la superficie privative dans l’acte de vente. L’absence de mention ou une erreur de plus de 5 % donne droit à l’acquéreur à des recours.",
    },
    {
      question: 'Quelle est la différence entre Carrez et Boutin ?',
      answer:
        "Carrez s’applique aux ventes de lots de copropriété et calcule la superficie privative. Boutin s’applique aux locations vides et calcule la surface habitable. Les deux notions sont proches mais ont des règles d’exclusion légèrement différentes.",
    },
    {
      question: 'Quelle est la tolérance d’erreur sur le mesurage Carrez ?',
      answer:
        "La tolérance est de 5 % entre la surface déclarée et la surface réelle. Au-delà, l’acquéreur peut demander une diminution proportionnelle du prix de vente dans le délai d’un an à compter de l’acte authentique.",
    },
    {
      question: 'Le mesurage est-il obligatoire pour une maison individuelle ?',
      answer:
        "Non, le mesurage Carrez ne s’applique qu’aux lots de copropriété. Le mesurage Boutin ne s’applique qu’aux locations nues. Pour une maison non en copropriété vendue ou louée, ils ne sont pas obligatoires.",
    },
    {
      question: 'Quelle est la durée de validité du mesurage Carrez ?',
      answer:
        "Le mesurage Carrez n’a pas de durée de validité limitée. Il reste valable tant que la configuration du lot n’a pas été modifiée (travaux modifiant la surface privative).",
    },
    {
      question: 'Combien coûte un mesurage Carrez ?',
      answer:
        "Entre 80 et 150 € TTC pour un appartement standard et entre 100 et 200 € pour un appartement complexe ou un local commercial. Le coût est généralement inclus dans le pack de diagnostics obligatoires à la vente.",
    },
    {
      question: 'Une véranda est-elle prise en compte dans la surface Carrez ?',
      answer:
        "Une véranda chauffée et intégrée structurellement au logement principal peut être incluse dans la surface Carrez si elle remplit les critères de hauteur (≥ 1,80 m) et d’étanchéité (close et couverte).",
    },
    {
      question: 'Que se passe-t-il en cas d’erreur de mesurage ?',
      answer:
        "Si l’écart entre surface déclarée et surface réelle dépasse 5 %, l’acquéreur (Carrez) ou le locataire (Boutin) peut demander une diminution proportionnelle du prix ou du loyer. L’action doit être intentée dans le délai d’un an pour Carrez.",
    },
    {
      question: 'Les balcons sont-ils inclus dans la surface Carrez ?',
      answer:
        "Non, les balcons, terrasses, loggias et autres parties non closes et couvertes ne sont pas incluses dans le calcul Carrez. Elles peuvent toutefois être mentionnées séparément dans le rapport.",
    },
    {
      question: 'Les caves et parkings sont-ils inclus dans la surface Carrez ?',
      answer:
        "Non, les caves, parkings, garages et autres locaux non principalement destinés à l’habitation ne sont pas inclus dans le calcul Carrez, sauf s’ils sont aménagés et intégrés au logement.",
    },
    {
      question: 'Qui réalise le mesurage Carrez ?',
      answer:
        "Le mesurage peut être réalisé par un diagnostiqueur certifié ou par un géomètre-expert. La certification n’est pas obligatoire mais constitue un gage de qualité.",
    },
    {
      question: 'Combien de temps faut-il pour réaliser un mesurage ?',
      answer:
        "Entre 30 minutes et 2 heures sur place selon la surface et la complexité du bien. Le rapport est généralement remis sous 24 à 48 heures.",
    },
    {
      question: 'Peut-on contester un mesurage Carrez ?',
      answer:
        "Oui, l’acquéreur peut faire réaliser un nouveau mesurage par un autre diagnostiqueur ou un géomètre-expert. En cas de désaccord, une expertise judiciaire peut être ordonnée pour trancher.",
    },
    {
      question: 'La mezzanine est-elle comptée dans le Carrez ?',
      answer:
        "Oui, une mezzanine est comptée dans la surface Carrez si elle a une hauteur sous plafond supérieure ou égale à 1,80 m et si elle est intégrée au lot privatif.",
    },
    {
      question: 'Que faire si je ne fais pas le mesurage Carrez ?',
      answer:
        "L’absence de mention de la superficie Carrez dans l’acte authentique entraîne la nullité de l’acte sur demande de l’acquéreur dans le délai d’un mois. Le mesurage est donc indispensable.",
    },
  ],
}
