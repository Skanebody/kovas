  ...
  sources: [
    {
      id: 1,
      title:
        'Article L126-28-1 du Code de la construction et de l’habitation (audit énergétique réglementaire)',
      organization: 'Légifrance · République française',
      url: 'https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000043978451',
      accessedAt: '2026-05-22',
    },
    {
      id: 2,
      title:
        'Arrêté du 4 mai 2022 relatif au contenu et aux modalités de réalisation de l’audit énergétique',
      organization: 'Légifrance · Journal officiel',
      url: 'https://www.legifrance.gouv.fr/jorf/id/JORFTEXT000045758007',
      accessedAt: '2026-05-22',
    },
    {
      id: 3,
      title:
        'Décret n° 2022-780 du 4 mai 2022 relatif à l’audit énergétique pour la vente de certaines maisons individuelles et immeubles',
      organization: 'Légifrance · Journal officiel',
      url: 'https://www.legifrance.gouv.fr/jorf/id/JORFTEXT000045758005',
      accessedAt: '2026-05-22',
    },
    {
      id: 4,
      title: 'France Rénov’ — Service public de la rénovation énergétique de l’habitat',
      organization: 'ADEME · Agence nationale de l’habitat (Anah)',
      url: 'https://france-renov.gouv.fr/',
      accessedAt: '2026-05-22',
    },
    {
      id: 5,
      title: 'MaPrimeRénov’ Parcours Accompagné — Aide pour les rénovations d’ampleur',
      organization: 'Agence nationale de l’habitat (Anah)',
      url: 'https://www.anah.gouv.fr/proprietaires/proprietaires-occupants/maprimerenov-parcours-accompagne',
      accessedAt: '2026-05-22',
    },
    {
      id: 6,
      title: 'Qualifications RGE Études (OPQIBI 1905, 1911) — Reconnu garant de l’environnement',
      organization: 'OPQIBI · Organisme de qualification de l’ingénierie',
      url: 'https://www.opqibi.com/qualifications-rge',
      accessedAt: '2026-05-22',
    },
    {
      id: 7,
      title: 'Audit énergétique : ce qu’il faut savoir avant la vente d’un logement',
      organization: 'Service-public.fr · DILA',
      url: 'https://www.service-public.fr/particuliers/vosdroits/F35403',
      accessedAt: '2026-05-22',
    },
    {
      id: 8,
      title: 'Observatoire DPE-Audit — Statistiques nationales',
      organization: 'ADEME',
