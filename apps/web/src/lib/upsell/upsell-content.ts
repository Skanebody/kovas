...
export const UPSELL_CATALOG: Record<UpsellTargetCode, UpsellCatalogEntry> = {
  ...
  cabinet: {
    ...
    description: "Jusqu'à 5 utilisateurs, 300 missions, multi-rôles et account manager dédié.",
    benefits: [
      '5 utilisateurs inclus + multi-rôles',
      '300 missions + 40h Whisper',
  ...
  logiciel_active: {
    ...
    benefits: ['100 missions / mois + 10h Whisper', 'Vision IA (100/mo)', 'Templates + support 4h'],
    priceLabel: '79€/mo HT',
    trialLabel: '14 jours gratuits',
  ...
  logiciel_cabinet: {
    ...
    kind: 'tier_upgrade',
    title: 'Cabinet',
    description: "Jusqu'à 5 utilisateurs, audit trail, Factur-X inclus.",
    benefits: [
      '300 missions / mois — 5 users',
  ...
  logiciel_enterprise: {
    ...
    benefits: [
      '1000 missions / mois (fair-use)',
      '80h Whisper + Vision IA 1500/mo',
      'API + jusqu’à 15 utilisateurs',
    ],
    priceLabel: '499€/mo HT',
    trialLabel: '14 jours gratuits',
  ...
  addon_extra_user: {
    ...
    description: 'Ajouter un utilisateur au plan Cabinet ou Cabinet+ (jusqu’à 15 max).',
    benefits: [
  ...
  addon_ia_volume: {
    ...
    description: 'Capacité Whisper et Vision IA étendue (réservé Pro et plus).',
    benefits: [
      'Heures Whisper supplémentaires',
      'Vision IA étendue',
      'Réservé aux plans Pro et plus',
    ],
    priceLabel: '19€/mo HT',
    trialLabel: '14 jours gratuits',
    ctaPrimary: 'Démarrer mon essai 14j',
  ...
  addon_conformite_avancee: {
    ...
    description: 'Factur-X PPF + Cockpit ADEME M2 + signatures eIDAS incluses (Pro et plus).',
    benefits: [
  ...
  solo_light: {
    ...
    title: 'Solo',
    description: 'Démarrer en solo sur les diagnostics standards.',
    benefits: ['40 missions / mois', '5h Whisper', '12 Go stockage'],
    priceLabel: '29€/mo HT',
    trialLabel: '14 jours gratuits',
    ctaPrimary: 'Passer sur Solo',
    category: 'productivity',
    icon: 'Layers',
  },
  solo_pro: {
  ...
  cabinet_plus: {
    ...
    kind: 'tier_upgrade',
    title: 'Cabinet+',
    description: 'API publique + SLA 4h + onboarding white-glove (jusqu’à 15 utilisateurs).',
    benefits: [
      '1000 missions / mois (fair-use)',
      '80h Whisper + Vision IA 1500/mo',
      'API + jusqu’à 15 utilisateurs',
