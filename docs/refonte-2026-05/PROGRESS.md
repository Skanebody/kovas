...
- **Harmonisation chrome public V5 sobre** : 11 pages publiques alignées sur le style home (`/`, `/tarifs`, `/comparatif`, `/temoignages`, `/api-publique`, `/demo`, `/a-propos`, `/aide`, `/observatoire`, `/presse`, `/contact`) — PublicHeader + SiteFooter + typo Urbanist medium + Instrument Serif italic mot-clé + bordures 0.08 + vouvoiement strict
