...
- **Tests Vitest** : **443 tests** pure-fn + helpers + cascading + equipment cache + incremental recompute + tools filter + transcription router + knowledge graph + InfoTooltip + fraud detection (passe 443/479, 36 skipped RLS DB live)
